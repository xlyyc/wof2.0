...
wof.functionWidget.spanner.ViewRecordComponentSpanner = function () {
    ...
    onReceiveMessage.push({id:'wof.functionWidget.ViewRecordComponent_active',method:'this._receivePropertysAndRenderSelf(message.sender);'});
...
wof.functionWidget.spanner.ViewRecordComponentSpanner.prototype = {
    ...
    _afterRender: function () {
        ...
        if(viewRecordComponent!=null){
            ...
            parameters.activeClass = 'ViewRecordComponent';
