...
wof.bizWidget.ObjectBar.prototype={
    ...
    _initRender: function(){
        ...
        toolbar.setComponentName(this.getClassName);
        ...
        if(layoutComponents.length>0){
            ...
            toolbarItem0.setComponentName(this.getClassName());
        ...
        if(bizWidgetComponents.length>0){
            ...
            toolbarItem1.setComponentName(this.getClassName());
        ...
        if(widgetComponents.length>0){
            ...
            toolbarItem2.setComponentName(this.getClassName());
        ...
        if(baseComponents.length>0) {
            ...
            toolbarItem3.setComponentName(this.getClassName());
        ...
        if(compositeComponents.length>0){
            ...
            toolbarItem4.setComponentName(this.getClassName());
